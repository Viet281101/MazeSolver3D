...
export class Toolbar {
	...
	private createButtons() {
		return [
			{ name: 'Custom Maze', icon: '/MazeSolver3D/icon/maze.png', action: () => this.togglePopup('maze'), x: 0, y: 0, width: 0, height: 0 },
			{ name: 'Solving Maze', icon: '/MazeSolver3D/icon/solving.png', action: () => this.togglePopup('solve'), x: 0, y: 0, width: 0, height: 0 },
			{ name: 'Tutorial', icon: '/MazeSolver3D/icon/question.png', action: () => this.togglePopup('tutorial'), x: 0, y: 0, width: 0, height: 0 },
			{ name: 'Settings', icon: '/MazeSolver3D/icon/setting.png', action: () => this.togglePopup('settings'), x: 0, y: 0, width: 0, height: 0 },
		];
	}
